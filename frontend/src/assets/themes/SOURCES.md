...
The bundled preview backgrounds are copied from the MIT-licensed
[FrenzyExists/wallpapers](https://github.com/FrenzyExists/wallpapers) repository.

- `anime-coffee-girl.jpg`: `Anime/anime-coffee-girl.jpg`
